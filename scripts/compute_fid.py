...
fid_score_model3=fid_fn(model3, fid, cosine_alpha, cosine_alpha_bar, cosine_posterior_variance)
fid_score_model4=fid_fn(model4, fid, cosine_alpha, cosine_alpha_bar, cosine_posterior_variance)
